...
pub mod anniversary_query {
    #![allow(dead_code)]
    pub const OPERATION_NAME: &'static str = "AnniversaryQuery";
    pub const QUERY : & 'static str = "query Query(\n  $identifier1:GroupID!,\n  $level: Int!, \n  $step:Int!,\n\t$startDate: NaiveDate!,\n\t$endDate:NaiveDate!) {\n  group(identifier: $identifier1) {\n    payscaleForLevel(level:$level) {\n      steps\n    }\n    identifier\n    payAtLevelAndStepBetweenDates(\n    \tlevel: $level\n      step: $step\n      startDate:$startDate\n      endDate:$endDate\n    ){\n      startDate\n      endDate\n      workDays\n      workHours\n      hourlyRate\n      annualRate\n      salary\n    }\n  }\n}\n\nquery AnniversaryQuery(\n  $identifier1:GroupID!,\n  $level: Int!, \n  $anniversaryDate:NaiveDate!,\n\t$startDate: NaiveDate!,\n\t$endDate:NaiveDate!) {\n  group(identifier: $identifier1) {\n    payscaleForLevel(level:$level) {\n      steps\n    }\n    identifier\n    payAtLevelByAnniversaryDateBetweenDates(\n    \tlevel: $level\n      anniversaryDate: $anniversaryDate\n      startDate:$startDate\n      endDate:$endDate\n    ){\n      step\n      startDate\n      endDate\n      workDays\n      workHours\n      hourlyRate\n      annualRate\n      salary\n    }\n  }\n}" ;
    use serde::{Deserialize, Serialize};
    #[allow(dead_code)]
    type Boolean = bool;
    ...
    #[derive(Deserialize)]
    pub struct AnniversaryQueryGroupPayscaleForLevel {
        pub steps: Int,
    }
    #[derive(Deserialize)]
    pub struct AnniversaryQueryGroupPayAtLevelByAnniversaryDateBetweenDates {
        pub step: Int,
        #[serde(rename = "startDate")]
        pub start_date: NaiveDate,
        #[serde(rename = "endDate")]
    ...
    #[derive(Deserialize)]
    pub struct AnniversaryQueryGroup {
        #[serde(rename = "payscaleForLevel")]
        pub payscale_for_level: Option<AnniversaryQueryGroupPayscaleForLevel>,
        pub identifier: GroupID,
        #[serde(rename = "payAtLevelByAnniversaryDateBetweenDates")]
        pub pay_at_level_by_anniversary_date_between_dates:
            Option<Vec<AnniversaryQueryGroupPayAtLevelByAnniversaryDateBetweenDates>>,
    }
    #[derive(Serialize)]
    pub struct Variables {
        pub identifier1: GroupID,
        pub level: Int,
        #[serde(rename = "anniversaryDate")]
    ...
    #[derive(Deserialize)]
    pub struct ResponseData {
        pub group: AnniversaryQueryGroup,
    }
}
impl graphql_client::GraphQLQuery for AnniversaryQuery {
    type Variables = anniversary_query::Variables;
    type ResponseData = anniversary_query::ResponseData;
    fn build_query(variables: Self::Variables) -> ::graphql_client::QueryBody<Self::Variables> {
        graphql_client::QueryBody {
            variables,
            query: anniversary_query::QUERY,
            operation_name: anniversary_query::OPERATION_NAME,
        }
    }
}
